...
On Windows or macOS with Docker Desktop, go to Settings > Resources > Proxies and set your proxy configuration there.
...
- `--outpu`t — Output directory where results will be saved.
